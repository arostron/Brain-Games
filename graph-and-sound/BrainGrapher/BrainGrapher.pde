...
import ddf.minim.*; 
Minim minim;
AudioPlayer[] audioplayers = new AudioPlayer[10];
AudioPlayer song; 
...
Brain2Beats[] brain2beatsList = new Brain2Beats[10];
...
void setup() {
  ...
  //set up sound playing files
  minim = new Minim(this); 
  brain2beatsList[0] = new Brain2Beats(70, "Attention", "gong.wav",audioplayers[0], minim); 
  brain2beatsList[1] = new Brain2Beats(70, "Meditation", "gong.wav",audioplayers[1], minim); 
